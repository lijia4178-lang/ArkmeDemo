...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "arrangements.subtitle": "把待执行、提醒和对话里的未来事项收在一起",
    "arrangements.add": "添加安排",
    "arrangements.scanMessages": "识别消息",
    "arrangements.recognizeSelf": "识别为安排",
    "arrangements.recognizing": "识别中...",
    "arrangements.filterPeople": "人物",
    "arrangements.filterTime": "时间",
    "arrangements.filterPlace": "地点",
    "arrangements.all": "全部",
    "arrangements.createTitle": "创建安排",
    "arrangements.editTitle": "修改安排",
    "arrangements.createDesc": "手动填写，或让 AI 从输入和测试消息中拆解安排。",
    "arrangements.naturalPlaceholder": "输入一句自然语言，比如：明天到公司帮小王带早餐",
    "arrangements.aiBreakdown": "AI拆解",
    "arrangements.createManual": "直接创建",
    "arrangements.fieldTitle": "标题",
    "arrangements.fieldPeople": "人物",
    "arrangements.fieldTime": "时间",
    "arrangements.fieldPlace": "地点",
    "arrangements.fieldDescription": "备注",
    "arrangements.importance": "重要程度",
    "arrangements.importanceLevel": "重要等级",
    "arrangements.importance1": "1级",
    "arrangements.importance2": "2级",
    "arrangements.importance3": "3级",
    "arrangements.importance4": "4级",
    "arrangements.importance5": "5级",
    "arrangements.aiDraft": "AI识别到一条安排",
    "arrangements.confirm": "确认安排",
    "arrangements.cancel": "取消",
    "arrangements.confirmed": "安排已确认",
    "arrangements.cancelled": "安排已取消",
    "arrangements.created": "安排已创建",
    "arrangements.titleRequired": "请先填写安排标题",
    "arrangements.timeRequired": "请先补充明确日期",
    "arrangements.timePending": "时间待确认",
    "arrangements.fieldScheduledDate": "明确日期",
    "arrangements.fieldScheduledTime": "具体时刻（选填）",
    "arrangements.tapToEdit": "点击卡片可修改内容",
    "arrangements.edit": "编辑",
    "arrangements.saveEdit": "保存修改",
    "arrangements.today": "今天",
    "arrangements.tomorrow": "明天",
    "arrangements.dayAfterTomorrow": "后天",
    "arrangements.aiFailed": "AI识别失败，请稍后再试",
    "arrangements.noMessageContext": "暂无可识别的测试消息",
    "arrangements.noSelfMessage": "暂无可识别的发给自己消息",
    "arrangements.emptyTitle": "还没有符合条件的安排",
    "arrangements.emptyDesc": "可以手动创建，也可以从测试消息中识别。",
    "arrangements.contextCount": "{count} 条上下文",
    "arrangements.noMeta": "暂无人物、时间或地点",
    "arrangements.confidence": "置信度 {value}",
    "arrangements.detailTitle": "安排详情",
    "arrangements.pendingBox": "待定箱",
    "arrangements.pendingBoxEmptyTitle": "待定箱还是空的",
    "arrangements.pendingBoxEmptyDesc": "到期提醒左滑，或在详情里切换状态后会收进这里。",
    "arrangements.dueNotice": "安排到期",
    "arrangements.swipeToPendingBox": "左滑加入待定箱",
    "arrangements.swipeToDone": "右滑已完成",
    "arrangements.swipeHandle": "滑块",
    "arrangements.statusTitle": "状态",
    "arrangements.contextTitle": "相关对话",
    "arrangements.noContext": "这条安排还没有关联对话",
    "arrangements.status.pending": "待执行",
    "arrangements.status.done": "已完成",
    "arrangements.status.later": "待定箱",
    "arrangements.aiConfigTitle": "安排 AI 设置",
    "arrangements.aiConfigDesc": "填写 OpenAI 兼容接口，用于把自然语言和消息识别为安排。",
    "arrangements.baseUrl": "Base URL",
    "arrangements.apiKey": "API Key",
    "arrangements.model": "模型",
    "arrangements.saveAiConfig": "保存 AI 设置",
    "arrangements.aiConfigSaved": "AI 设置已保存",
  ...
  "zh-TW": {
    ...
    "settings.current": "目前",
    "arrangements.title": "安排",
    "arrangements.subtitle": "把待執行、提醒和對話裡的未來事項收在一起",
    "arrangements.add": "新增安排",
    "arrangements.scanMessages": "識別訊息",
    "arrangements.recognizeSelf": "識別為安排",
    "arrangements.recognizing": "識別中...",
    "arrangements.filterPeople": "人物",
    "arrangements.filterTime": "時間",
    "arrangements.filterPlace": "地點",
    "arrangements.all": "全部",
    "arrangements.createTitle": "建立安排",
    "arrangements.editTitle": "修改安排",
    "arrangements.createDesc": "手動填寫，或讓 AI 從輸入和測試訊息中拆解安排。",
    "arrangements.naturalPlaceholder": "輸入一句自然語言，例如：明天到公司幫小王帶早餐",
    "arrangements.aiBreakdown": "AI 拆解",
    "arrangements.createManual": "直接建立",
    "arrangements.fieldTitle": "標題",
    "arrangements.fieldPeople": "人物",
    "arrangements.fieldTime": "時間",
    "arrangements.fieldPlace": "地點",
    "arrangements.fieldDescription": "備註",
    "arrangements.importance": "重要程度",
    "arrangements.importanceLevel": "重要等級",
    "arrangements.importance1": "1級",
    "arrangements.importance2": "2級",
    "arrangements.importance3": "3級",
    "arrangements.importance4": "4級",
    "arrangements.importance5": "5級",
    "arrangements.aiDraft": "AI 識別到一條安排",
    "arrangements.confirm": "確認安排",
    "arrangements.cancel": "取消",
    "arrangements.confirmed": "安排已確認",
    "arrangements.cancelled": "安排已取消",
    "arrangements.created": "安排已建立",
    "arrangements.titleRequired": "請先填寫安排標題",
    "arrangements.timeRequired": "請先補充明確日期",
    "arrangements.timePending": "時間待確認",
    "arrangements.fieldScheduledDate": "明確日期",
    "arrangements.fieldScheduledTime": "具體時刻（選填）",
    "arrangements.tapToEdit": "點擊卡片可修改內容",
    "arrangements.edit": "編輯",
    "arrangements.saveEdit": "儲存修改",
    "arrangements.today": "今天",
    "arrangements.tomorrow": "明天",
    "arrangements.dayAfterTomorrow": "後天",
    "arrangements.aiFailed": "AI 識別失敗，請稍後再試",
    "arrangements.noMessageContext": "暫無可識別的測試訊息",
    "arrangements.noSelfMessage": "暫無可識別的發給自己訊息",
    "arrangements.emptyTitle": "還沒有符合條件的安排",
    "arrangements.emptyDesc": "可以手動建立，也可以從測試訊息中識別。",
    "arrangements.contextCount": "{count} 條上下文",
    "arrangements.noMeta": "暫無人物、時間或地點",
    "arrangements.confidence": "置信度 {value}",
    "arrangements.detailTitle": "安排詳情",
    "arrangements.pendingBox": "待定箱",
    "arrangements.pendingBoxEmptyTitle": "待定箱還是空的",
    "arrangements.pendingBoxEmptyDesc": "到期提醒左滑，或在詳情裡切換狀態後會收進這裡。",
    "arrangements.dueNotice": "安排到期",
    "arrangements.swipeToPendingBox": "左滑加入待定箱",
    "arrangements.swipeToDone": "右滑已完成",
    "arrangements.swipeHandle": "滑塊",
    "arrangements.statusTitle": "狀態",
    "arrangements.contextTitle": "相關對話",
    "arrangements.noContext": "這條安排還沒有關聯對話",
    "arrangements.status.pending": "待執行",
    "arrangements.status.done": "已完成",
    "arrangements.status.later": "待定箱",
    "arrangements.aiConfigTitle": "安排 AI 設定",
    "arrangements.aiConfigDesc": "填寫 OpenAI 相容接口，用於把自然語言和訊息識別為安排。",
    "arrangements.baseUrl": "Base URL",
    "arrangements.apiKey": "API Key",
    "arrangements.model": "模型",
    "arrangements.saveAiConfig": "儲存 AI 設定",
    "arrangements.aiConfigSaved": "AI 設定已儲存",
  ...
  "en-US": {
    ...
    "arrangements.subtitle": "Collect future actions, reminders, and conversation follow-ups",
    "arrangements.add": "Add plan",
    "arrangements.scanMessages": "Scan messages",
    "arrangements.recognizeSelf": "Recognize as plan",
    "arrangements.recognizing": "Recognizing...",
    "arrangements.filterPeople": "People",
    "arrangements.filterTime": "Time",
    "arrangements.filterPlace": "Place",
    "arrangements.all": "All",
    "arrangements.createTitle": "Create plan",
    "arrangements.editTitle": "Edit plan",
    "arrangements.createDesc": "Fill it manually, or let AI extract a plan from text and test messages.",
    "arrangements.naturalPlaceholder": "Type naturally, e.g. bring breakfast for Alex tomorrow at work",
    "arrangements.aiBreakdown": "AI breakdown",
    "arrangements.createManual": "Create",
    "arrangements.fieldTitle": "Title",
    "arrangements.fieldPeople": "People",
    "arrangements.fieldTime": "Time",
    "arrangements.fieldPlace": "Place",
    "arrangements.fieldDescription": "Note",
    "arrangements.importance": "Importance",
    "arrangements.importanceLevel": "Importance",
    "arrangements.importance1": "Level 1",
    "arrangements.importance2": "Level 2",
    "arrangements.importance3": "Level 3",
    "arrangements.importance4": "Level 4",
    "arrangements.importance5": "Level 5",
    "arrangements.aiDraft": "AI found a plan",
    "arrangements.confirm": "Confirm",
    "arrangements.cancel": "Cancel",
    "arrangements.confirmed": "Plan confirmed",
    "arrangements.cancelled": "Plan cancelled",
    "arrangements.created": "Plan created",
    "arrangements.titleRequired": "Please enter a title first",
    "arrangements.timeRequired": "Please add a specific date first",
    "arrangements.timePending": "Time pending",
    "arrangements.fieldScheduledDate": "Specific date",
    "arrangements.fieldScheduledTime": "Specific time (optional)",
    "arrangements.tapToEdit": "Tap the card to edit",
    "arrangements.edit": "Edit",
    "arrangements.saveEdit": "Save changes",
    "arrangements.today": "Today",
    "arrangements.tomorrow": "Tomorrow",
    "arrangements.dayAfterTomorrow": "Day after tomorrow",
    "arrangements.aiFailed": "AI recognition failed. Try again later.",
    "arrangements.noMessageContext": "No test messages to scan",
    "arrangements.noSelfMessage": "No self message to recognize",
    "arrangements.emptyTitle": "No matching plans yet",
    "arrangements.emptyDesc": "Create one manually or scan test messages.",
    "arrangements.contextCount": "{count} contexts",
    "arrangements.noMeta": "No people, time, or place",
    "arrangements.confidence": "Confidence {value}",
    "arrangements.detailTitle": "Plan detail",
    "arrangements.pendingBox": "Pending box",
    "arrangements.pendingBoxEmptyTitle": "The pending box is empty",
    "arrangements.pendingBoxEmptyDesc": "Swipe due reminders left, or change a plan status in detail.",
    "arrangements.dueNotice": "Plan due",
    "arrangements.swipeToPendingBox": "Swipe left to pending",
    "arrangements.swipeToDone": "Swipe right to done",
    "arrangements.swipeHandle": "Slider",
    "arrangements.statusTitle": "Status",
    "arrangements.contextTitle": "Related conversations",
    "arrangements.noContext": "No linked conversations yet",
    "arrangements.status.pending": "To do",
    "arrangements.status.done": "Done",
    "arrangements.status.later": "Pending box",
    "arrangements.aiConfigTitle": "Plan AI settings",
    "arrangements.aiConfigDesc": "Add an OpenAI-compatible endpoint to recognize plans from text and messages.",
    "arrangements.baseUrl": "Base URL",
    "arrangements.apiKey": "API Key",
    "arrangements.model": "Model",
    "arrangements.saveAiConfig": "Save AI settings",
    "arrangements.aiConfigSaved": "AI settings saved",
