...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "arrangements.importance1": "普通",
    "arrangements.importance2": "重要",
    "arrangements.importance3": "最重要",
    ...
    "arrangements.timeRequired": "请先补充明确日期时间",
    "arrangements.timePending": "时间待确认",
    "arrangements.fieldScheduledAt": "明确日期时间",
  ...
  "zh-TW": {
    ...
    "arrangements.timeRequired": "請先補充明確日期時間",
    "arrangements.timePending": "時間待確認",
    "arrangements.fieldScheduledAt": "明確日期時間",
    "arrangements.today": "今天",
    "arrangements.tomorrow": "明天",
  ...
  "en-US": {
    ...
    "arrangements.importance1": "Normal",
    "arrangements.importance2": "Important",
    "arrangements.importance3": "Top",
    ...
    "arrangements.timeRequired": "Please add a specific date and time first",
    "arrangements.timePending": "Time pending",
    "arrangements.fieldScheduledAt": "Specific date and time",
